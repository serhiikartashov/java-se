...
class HashGeneratorTest {
    ...
    @Test
    void validatePasswordRoutine() {
        String secretPhrase = "something here that you can remember";
        String passwordHash = HashGenerator.createPasswordHash(secretPhrase);
        System.out.println(passwordHash);
        assertTrue(HashGenerator.validatePasswordHash(secretPhrase, passwordHash));
    }
}