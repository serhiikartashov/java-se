...
public class KeyStoreUtils {
    ...
    public static KeyStore createPrivateKeyJavaKeyStore(String keystorePassword, String keyAlieas, SecretKey secretKey, String secretKeyPassword) throws Exception {
        KeyStore keyStore = KeyStore.getInstance(SECRET_KEY_KEYSTORE_TYPE);
        keyStore.load(null, keystorePassword.toCharArray()); // in memory, set null
        ...
        keyStore.setEntry(keyAlieas, privateKeyEntry, entryPassword);
        return keyStore;
    }
}
