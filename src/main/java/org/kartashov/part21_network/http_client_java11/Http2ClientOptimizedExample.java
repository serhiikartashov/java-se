package org.kartashov.part21_network.http_client_java11;
...
public class Http2ClientOptimizedExample {
	...
	static Logger logger = LoggerFactory.getLogger(Http2ClientOptimizedExample.class.getName());

    static ExecutorService executor = Executors.newFixedThreadPool(20, r -> {
