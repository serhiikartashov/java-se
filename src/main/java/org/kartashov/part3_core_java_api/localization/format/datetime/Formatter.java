package org.kartashov.part3_core_java_api.localization.format.datetime;
...
public class Formatter {
    ...
    private static void predefinedFormatters() {
        ...
        System.out.println("long:" + ld1_f1);
        System.out.println("full:" + ld1_f2);
        System.out.println("short:" + ld1_f3);
        System.out.println("medium:" + ld1_f4);
